...
Send reminders to customers when downloads they purchased have expired
...
1.   Select "downloadable" product, set your renewal price and download expiration date
2.   Download Expired email with notice of which download file(s) are expired
...
*   Updated the `DownloadRenewalsForWooCommerce` class name throughout multiple files in the plugin

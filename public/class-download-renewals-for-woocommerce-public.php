...
class Download_Renewals_For_Woocommerce_Public {
	...
	public function enqueue_styles() {
		 ...
		 * defined in Download_Renewals_For_Woocommerce_Loader as all of the hooks are defined
		 * in that particular class.
		 *
		 * The Download_Renewals_For_Woocommerce_Loader will then create the relationship
